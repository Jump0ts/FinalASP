<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mod_El.aspx.cs" Inherits="ProyectoFinal.Mod_El" %>
        ...
        <div style="padding-left:450px; padding-top:100px">
            ...
            <div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList runat="server" AutoPostBack="true" ID="listCod" Width="200px" class="form-control search-slt" OnSelectedIndexChanged="listCod_SelectedIndexChanged">
                ...
                <div class="form-group row">
                    <asp:Button runat="server" ID="btnAccion" type="button" class="btn btn-danger wrn-btn" Text="Insertar" OnClick="btnAccion_Click"></asp:Button>
                    <div class="col-sm-10">
